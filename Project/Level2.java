...
public class Level2 extends MyWorld
{
     ...
     */
    public Level2() {
        setPaintOrder(Stop.class , KeyPass.class, LeftBorder.class, RightBorder. class, CatCatcher.class, Coin.class, BallTreat.class, Cactus.class, Cactus2.class, Train.class, Train2.class);
        prepare();
        showLife();
        showScore();
        stopGame();
    ...
    private void prepare() {
        ...
        for(int i = 0; i < 5; i++) {
            addObject(new CatTreats2(), Greenfoot.getRandomNumber(1500)+ 60, Greenfoot.getRandomNumber(510)+ 40); 
        }   
        ...
        // Cat Catchers
        addObject(new CatCatcher() ,1200, 130);
        addObject(new CatCatcher() ,500, 470);
